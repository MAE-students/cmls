...
\vspace{0.5cm}
%\Large{\textbf{\@author}}  % Displays the author's name
\normalsize

\vspace{2pt}
%\large{\textbf{Student IDs: \@ID}}  % Displays student ID(s)
\normalsize

\vspace{0.5cm}
%\normalsize{\textbf{Advisor: \@advisor}}  % Displays the advisor's name
\normalsize

\vspace{4cm}
%\input{01_FrontMatter/02_abstract}  % Includes the abstract from an external file
